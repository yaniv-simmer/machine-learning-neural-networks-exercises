...
class model:
    def __init__(self, hidden_layer_dimensions: List[int], input_data: np.ndarray, target_labels: np.ndarray,
        ...
        self.weights = self.init_weights(self.layer_dimensions)
    ...
    def init_weights(self, layer_dimensions: List[int]) -> List[np.ndarray]:
        """
        ...
        :param layer_dimensions: A list of the number of neurons in each layer.
